        ...
        <table>
            <thead>
                <tr>
                    ...
                    :key="index"
                    :class="{'align-right': item.dataType == Resource.DataTypeColumn.Number, 
            ...
            <tbody>
                ...
                >
                    <td 
                        ...
                        :key="index"
                        :class="{'align-right': column.dataType == Resource.DataTypeColumn.Number, 
                        'align-center': column.dataType == Resource.DataTypeColumn.Date}"
                    >
                    {{ formatValue(row[column.fieldName], column.dataType, column.displayType)}}
